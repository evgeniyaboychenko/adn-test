...
/* harmony import */ var _modules_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/filter */ "./js/modules/filter.js");
/* harmony import */ var _modules_range_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/range-slider */ "./js/modules/range-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_1__["accordionHide"])();
    Object(_modules_filter__WEBPACK_IMPORTED_MODULE_2__["filterShow"])();
    Object(_modules_range_slider__WEBPACK_IMPORTED_MODULE_3__["rangeSlider"])();
  });
});
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: accordionHide */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionHide", function() { return accordionHide; });
var accordionHide = function accordionHide() {
...
/*!******************************!*\
  !*** ./js/modules/filter.js ***!
  \******************************/
/*! exports provided: filterShow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterShow", function() { return filterShow; });
var filterShow = function filterShow() {
  var filtersShowBtn = document.querySelector('[data-filters-btn]');
  var filtersBlock = document.querySelector('.filters');
  var filtersCloseAreas = document.querySelectorAll('[data-close-filters]');
  var bodyPage = document.querySelector('body');
  if (!filtersShowBtn || !filtersBlock || !filtersCloseAreas) {
    return;
  }
  var onButtonShowFilter = function onButtonShowFilter() {
    if (!filtersBlock.classList.contains('is-open')) {
      filtersBlock.classList.add('is-open');
      bodyPage.style.overflow = 'hidden';
    }
  };
  var onAreaCloseFilter = function onAreaCloseFilter() {
    if (filtersBlock.classList.contains('is-open')) {
  ...
  filtersCloseAreas.forEach(function (item) {
...
var rangeSlider = function rangeSlider() {
  var slider = document.querySelector('[data-range-slider]');
  var inputMin = document.querySelector('[data-min-price]');
  var inputMax = document.querySelector('[data-max-price]');
  ...
  var onChangeInputsetValueRange = function onChangeInputsetValueRange(index, value) {
    var range = [null, null];
    range[index] = value;
    slider.noUiSlider.set(range);
  };
  inputMin.addEventListener('change', function (evt) {
    onChangeInputsetValueRange(0, evt.currentTarget.value);
  });
  inputMax.addEventListener('change', function (evt) {
